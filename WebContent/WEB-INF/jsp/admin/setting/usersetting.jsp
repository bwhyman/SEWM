...
<myTemplate:template>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<div class="row">
			<div class="col-md-2">
			<a class="btn btn-info btn-block" role="button" href="admin/setting/userauthsetting">用户权限管理</a>
			</div>
			</div>
		</div>
		<div class="panel-body">
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<div class="row">
			<div class="col-md-2">
			<a class="btn btn-info btn-block" role="button" href="admin/setting/userinvisetting">用户监考设置</a>
			</div>
			</div>
		</div>
		<div class="panel-body">
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<div class="row">
			<div class="col-md-2">
			<a class="btn btn-info btn-block" role="button" href="admin/setting/usernotifsetting">用户通知设置</a>
			</div>
			</div>
		</div>
		<div class="panel-body">
