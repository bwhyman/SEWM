...
<myTemplate:template>
	...
	<ol class="breadcrumb">
  <li><a href="">主页</a></li>
  <li><a href="admin/usersetting">监考管理</a></li>
  <li class="active">监考分配</li>
		...
		<thead>
			...
			<tbody>	
				...
				<td>
						<a class="btn btn-primary" href="${i.id }" role="button">编辑</a>  	
			
				</tr>
			</tbody>
	</table>
	     
	     <form class="form-horizontal " action="admin/assigninvi" method="POST">
					...
					<div class="form-group">
						...
						<span class="label label-success">推荐</span>
							...
							<c:forEach items="${olders }" var="t" varStatus="s">
								...
								<input type="checkbox" name="checkeds" value="${t.key }" data-toggle="checkbox"  checked="checked">
			...
			<div class="form-group">
						<div class="col-sm-2 col-md-1 control-label">
						<span class="label label-default">通知关闭</span>
						</div>
							<div class="col-sm-10 col-md-10">
				...
				<div class="form-group">
						...
						<div class="col-sm-10 col-md-11">
							...
							<span class="label label-success checkboxspan">新推荐分配</span>
							...
							推荐规则：监考时间与授课时间无冲突，与其他监考时间无冲突，开启推荐，开启通知，按目前分配监考次数倒序排列；<br>
